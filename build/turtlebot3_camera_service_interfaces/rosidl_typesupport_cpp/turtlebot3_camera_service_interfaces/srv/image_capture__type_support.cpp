...
static const _ImageCapture_Request_type_support_symbol_names_t _ImageCapture_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture_Request)),
  }
};
...
{
  return &::turtlebot3_camera_service_interfaces::srv::rosidl_typesupport_cpp::ImageCapture_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture_Request)() {
  return get_message_type_support_handle<turtlebot3_camera_service_interfaces::srv::ImageCapture_Request>();
}
...
static const _ImageCapture_Response_type_support_symbol_names_t _ImageCapture_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture_Response)),
  }
};
...
{
  return &::turtlebot3_camera_service_interfaces::srv::rosidl_typesupport_cpp::ImageCapture_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture_Response)() {
  return get_message_type_support_handle<turtlebot3_camera_service_interfaces::srv::ImageCapture_Response>();
}
...
static const _ImageCapture_type_support_symbol_names_t _ImageCapture_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture)),
  }
};
...
{
  return &::turtlebot3_camera_service_interfaces::srv::rosidl_typesupport_cpp::ImageCapture_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_camera_service_interfaces, srv, ImageCapture)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtlebot3_camera_service_interfaces::srv::ImageCapture>();
}
