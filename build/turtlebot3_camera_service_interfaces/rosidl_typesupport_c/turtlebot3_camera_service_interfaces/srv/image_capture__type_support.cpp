...
static const _ImageCapture_Request_type_support_symbol_names_t _ImageCapture_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_camera_service_interfaces, srv, ImageCapture_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_camera_service_interfaces, srv, ImageCapture_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_camera_service_interfaces, srv, ImageCapture_Request)() {
  return &::turtlebot3_camera_service_interfaces::srv::rosidl_typesupport_c::ImageCapture_Request_message_type_support_handle;
}
...
static const _ImageCapture_Response_type_support_symbol_names_t _ImageCapture_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_camera_service_interfaces, srv, ImageCapture_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_camera_service_interfaces, srv, ImageCapture_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_camera_service_interfaces, srv, ImageCapture_Response)() {
  return &::turtlebot3_camera_service_interfaces::srv::rosidl_typesupport_c::ImageCapture_Response_message_type_support_handle;
}
...
static const _ImageCapture_type_support_symbol_names_t _ImageCapture_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_camera_service_interfaces, srv, ImageCapture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_camera_service_interfaces, srv, ImageCapture)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_camera_service_interfaces, srv, ImageCapture)() {
  return &::turtlebot3_camera_service_interfaces::srv::rosidl_typesupport_c::ImageCapture_service_type_support_handle;
}
